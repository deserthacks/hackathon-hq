...
module.exports = function(app) {
  ...
  app.use('/application-configs', require('./api/application-config'));
  app.use('/modules', require('./api/application-module'));
  app.use('/templates', require('./api/application-template'));
