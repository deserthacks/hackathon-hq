...
var config = {
  ...
  attendees: {
    ...
    roles: ['participant', 'mentor', 'volunteer', 'organizer', 'sponsor']
  },

  applications: {
    status: ['received', 'in-review', 'reviewed']
  },
  ...
  pebble: {
    api_key: process.env.PEBBLE_API_KEY || 'SBung7j7hqezhqkc6b000eqoscmpd3sc'
  }
};
