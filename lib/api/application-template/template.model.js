...
var ApplicationTemplateModel = new Schema({
  ...
  application_config: { type: Schema.Types.ObjectId, ref: 'ApplicationConfig', required: true },
...
ApplicationTemplateModel
  .pre('save', function(next) {
    console.log('template being created', this);
    next();
  })
  .pre('remove', function(next) {
    console.log('template getting removed', this);
    next();
  });
