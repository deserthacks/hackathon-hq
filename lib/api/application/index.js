...
router.get('/configs', auth.authenticated(), auth.hasRole('admin'), controller.getConfigs);
router.get('/templates', auth.authenticated(), auth.hasRole('admin'), controller.getTemplates);
...
// Update
router.put('/configs/:configId', auth.authenticated(), auth.hasRole('admin'), controller.updateConfigs);
